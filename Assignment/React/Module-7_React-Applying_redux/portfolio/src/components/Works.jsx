            ...
            >
              ...
              <div className='transition-bg duration-500 ease-in-out group-hover:bg-black group-hover:bg-opacity-75 flex justify-center items-center flex-col text-center p-4 w-full h-full rounded-md'>
                ...
                <p className='text-gray-300 text-sm mt-2'>
                  A web application built with React and MongoDB
                </p>
                <div className='pt-6'>
                  <a href='/'>
                  ...
                  <a href='/'>
                    <button className='text-center rounded-lg px-4 py-2 m-2 bg-transparent border-2 border-white text-white font-bold text-base hover:bg-cyan-200 hover:text-cyan-950'>
                      Code
                    </button>
                  </a>
                </div>
